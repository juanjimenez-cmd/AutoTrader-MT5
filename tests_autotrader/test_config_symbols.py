...
class ConfigAndSymbolTests(unittest.TestCase):
    ...
    def test_conservative_demo_risk_defaults(self):
        ...
        self.assertEqual(config.sessions.entry_schedules["USDJPY"].windows, ("09:00-11:00",))
        ...
        self.assertEqual(config.timeframes, ("M5", "M15", "H1"))
        self.assertEqual(config.min_score, 75)
        self.assertEqual(config.entry_controls.cooldown_minutes, 90)
        self.assertEqual(config.entry_controls.max_entries_per_symbol_day, 2)
